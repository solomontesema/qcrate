...
STREAM_TRIGGER_SHOT_ID = STREAM_BASE + 0x030
STREAM_TRIGGER_COUNT = STREAM_BASE + 0x034
STREAM_MISSED_TRIGGER_COUNT = STREAM_BASE + 0x038
STREAM_TRIGGER_TIME_LOW = STREAM_BASE + 0x03C
STREAM_TRIGGER_TIME_HIGH = STREAM_BASE + 0x040
STREAM_FIRST_SAMPLE_TIME_LOW = STREAM_BASE + 0x044
STREAM_FIRST_SAMPLE_TIME_HIGH = STREAM_BASE + 0x048
STREAM_CAPTURE_CONFIG_ID_LOW = STREAM_BASE + 0x04C
STREAM_CAPTURE_CONFIG_ID_HIGH = STREAM_BASE + 0x050

DSP_CONFIG_BASE = 0x3000
DSP_CONFIG_COMMAND = DSP_CONFIG_BASE + 0x000
DSP_CONFIG_STATUS = DSP_CONFIG_BASE + 0x004
DSP_CONFIG_REJECT_REASON = DSP_CONFIG_BASE + 0x008
DSP_CONFIG_ACTIVE_GENERATION = DSP_CONFIG_BASE + 0x00C
DSP_CONFIG_SHADOW_CONFIG_ID_LOW = DSP_CONFIG_BASE + 0x010
DSP_CONFIG_SHADOW_CONFIG_ID_HIGH = DSP_CONFIG_BASE + 0x014
DSP_CONFIG_SHADOW_SIGNAL_INCREMENT = DSP_CONFIG_BASE + 0x018
DSP_CONFIG_SHADOW_SIGNAL_INITIAL = DSP_CONFIG_BASE + 0x01C
DSP_CONFIG_SHADOW_SIGNAL_AMPLITUDE = DSP_CONFIG_BASE + 0x020
DSP_CONFIG_SHADOW_NOISE_AMPLITUDE = DSP_CONFIG_BASE + 0x024
DSP_CONFIG_SHADOW_NOISE_SEED = DSP_CONFIG_BASE + 0x028
DSP_CONFIG_SHADOW_LO_INCREMENT = DSP_CONFIG_BASE + 0x02C
DSP_CONFIG_SHADOW_LO_INITIAL = DSP_CONFIG_BASE + 0x030
DSP_CONFIG_ACTIVE_CONFIG_ID_LOW = DSP_CONFIG_BASE + 0x040
DSP_CONFIG_ACTIVE_CONFIG_ID_HIGH = DSP_CONFIG_BASE + 0x044
DSP_CONFIG_ACTIVE_SIGNAL_INCREMENT = DSP_CONFIG_BASE + 0x048
DSP_CONFIG_ACTIVE_SIGNAL_INITIAL = DSP_CONFIG_BASE + 0x04C
DSP_CONFIG_ACTIVE_SIGNAL_AMPLITUDE = DSP_CONFIG_BASE + 0x050
DSP_CONFIG_ACTIVE_NOISE_AMPLITUDE = DSP_CONFIG_BASE + 0x054
DSP_CONFIG_ACTIVE_NOISE_SEED = DSP_CONFIG_BASE + 0x058
DSP_CONFIG_ACTIVE_LO_INCREMENT = DSP_CONFIG_BASE + 0x05C
DSP_CONFIG_ACTIVE_LO_INITIAL = DSP_CONFIG_BASE + 0x060
...
REGISTERS = [
    ...
    Register("STREAM.TRIGGER_SHOT_ID", STREAM_TRIGGER_SHOT_ID),
    Register("STREAM.TRIGGER_COUNT", STREAM_TRIGGER_COUNT),
    Register("STREAM.MISSED_TRIGGER_COUNT", STREAM_MISSED_TRIGGER_COUNT),
    Register("STREAM.TRIGGER_TIME_LOW", STREAM_TRIGGER_TIME_LOW),
    Register("STREAM.TRIGGER_TIME_HIGH", STREAM_TRIGGER_TIME_HIGH),
    Register("STREAM.FIRST_SAMPLE_TIME_LOW", STREAM_FIRST_SAMPLE_TIME_LOW),
    Register("STREAM.FIRST_SAMPLE_TIME_HIGH", STREAM_FIRST_SAMPLE_TIME_HIGH),
    Register("STREAM.CAPTURE_CONFIG_ID_LOW", STREAM_CAPTURE_CONFIG_ID_LOW),
    Register("STREAM.CAPTURE_CONFIG_ID_HIGH", STREAM_CAPTURE_CONFIG_ID_HIGH),
    Register("DSP_CONFIG.STATUS", DSP_CONFIG_STATUS),
    Register("DSP_CONFIG.REJECT_REASON", DSP_CONFIG_REJECT_REASON),
    Register("DSP_CONFIG.ACTIVE_GENERATION", DSP_CONFIG_ACTIVE_GENERATION),
    Register("DSP_CONFIG.SHADOW_CONFIG_ID_LOW", DSP_CONFIG_SHADOW_CONFIG_ID_LOW),
    Register("DSP_CONFIG.SHADOW_CONFIG_ID_HIGH", DSP_CONFIG_SHADOW_CONFIG_ID_HIGH),
    Register("DSP_CONFIG.SHADOW_SIGNAL_INCREMENT", DSP_CONFIG_SHADOW_SIGNAL_INCREMENT),
    Register("DSP_CONFIG.SHADOW_SIGNAL_INITIAL", DSP_CONFIG_SHADOW_SIGNAL_INITIAL),
    Register("DSP_CONFIG.SHADOW_SIGNAL_AMPLITUDE", DSP_CONFIG_SHADOW_SIGNAL_AMPLITUDE),
    Register("DSP_CONFIG.SHADOW_NOISE_AMPLITUDE", DSP_CONFIG_SHADOW_NOISE_AMPLITUDE),
    Register("DSP_CONFIG.SHADOW_NOISE_SEED", DSP_CONFIG_SHADOW_NOISE_SEED),
    Register("DSP_CONFIG.SHADOW_LO_INCREMENT", DSP_CONFIG_SHADOW_LO_INCREMENT),
    Register("DSP_CONFIG.SHADOW_LO_INITIAL", DSP_CONFIG_SHADOW_LO_INITIAL),
    Register("DSP_CONFIG.ACTIVE_CONFIG_ID_LOW", DSP_CONFIG_ACTIVE_CONFIG_ID_LOW),
    Register("DSP_CONFIG.ACTIVE_CONFIG_ID_HIGH", DSP_CONFIG_ACTIVE_CONFIG_ID_HIGH),
    Register("DSP_CONFIG.ACTIVE_SIGNAL_INCREMENT", DSP_CONFIG_ACTIVE_SIGNAL_INCREMENT),
    Register("DSP_CONFIG.ACTIVE_SIGNAL_INITIAL", DSP_CONFIG_ACTIVE_SIGNAL_INITIAL),
    Register("DSP_CONFIG.ACTIVE_SIGNAL_AMPLITUDE", DSP_CONFIG_ACTIVE_SIGNAL_AMPLITUDE),
    Register("DSP_CONFIG.ACTIVE_NOISE_AMPLITUDE", DSP_CONFIG_ACTIVE_NOISE_AMPLITUDE),
    Register("DSP_CONFIG.ACTIVE_NOISE_SEED", DSP_CONFIG_ACTIVE_NOISE_SEED),
    Register("DSP_CONFIG.ACTIVE_LO_INCREMENT", DSP_CONFIG_ACTIVE_LO_INCREMENT),
    Register("DSP_CONFIG.ACTIVE_LO_INITIAL", DSP_CONFIG_ACTIVE_LO_INITIAL),
]
...
def command_smoke(regs: DevMem32, skip_writes: bool) -> None:
    ...
    dsp_status = regs.read32(DSP_CONFIG_STATUS)
    if not dsp_status & (1 << 2):
        raise RuntimeError(
            f"DSP_CONFIG.STATUS: active configuration is invalid "
            f"(0x{dsp_status:08x})"
        )
    if dsp_status & (1 << 1):
        raise RuntimeError(
            f"DSP_CONFIG.STATUS: commit mailbox is busy (0x{dsp_status:08x})"
        )
    for _ in range(3):
        dsp_generation = regs.read32(DSP_CONFIG_ACTIVE_GENERATION)
        dsp_config_id = (
            regs.read32(DSP_CONFIG_ACTIVE_CONFIG_ID_LOW)
            | (regs.read32(DSP_CONFIG_ACTIVE_CONFIG_ID_HIGH) << 32)
        )
        if regs.read32(DSP_CONFIG_ACTIVE_GENERATION) == dsp_generation:
            break
    else:
        raise RuntimeError("DSP active configuration changed during readback")
    print(f"OK  DSP_CONFIG.STATUS             0x{dsp_status:08x}")
    print(f"OK  DSP_CONFIG.ACTIVE_GENERATION  0x{dsp_generation:08x}")
    print(f"OK  DSP_CONFIG.ACTIVE_ID          0x{dsp_config_id:016x}")
